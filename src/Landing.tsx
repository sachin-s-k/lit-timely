...
//   opacity: 0;
//   transform: scaleY(0);
//   animation: foldIn 0.5s ease forwards;
//   animation-delay: calc(0.1s * var(--i)); /* Delay for each letter */
// }

// .space {
//   display: inline-block;
//   width: 2px; /* Space between words */
// }

// .word {
//   display: inline-block;
//   animation: foldInWord 1s ease forwards;
// }

// @keyframes foldInWord {
//   0% {
//     opacity: 0;
//   }
//   100% {
...
// h2 .word:nth-child(1) { animation-delay: 0s; }
// h2 .word:nth-child(2) { animation-delay: 1s; } /* Delay second word */
// h2 .word:nth-child(3) { animation-delay: 2s; } /* Delay third word */
// h2 .word:nth-child(4) { animation-delay: 3s; } /* Delay fourth word */

// h2 .letter:nth-child(1) { --i: 1; }
// h2 .letter:nth-child(2) { --i: 2; }
// h2 .letter:nth-child(3) { --i: 3; }
// h2 .letter:nth-child(4) { --i: 4; }
// h2 .letter:nth-child(5) { --i: 5; }
// h2 .letter:nth-child(6) { --i: 6; }
// h2 .letter:nth-child(7) { --i: 7; }
// h2 .letter:nth-child(8) { --i: 8; }
