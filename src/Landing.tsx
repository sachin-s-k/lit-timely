...
//     try {
//       const response = await axios.post(
//         `${import.meta.env.VITE_BACKEND_API_BASE_URL}/auth/forgot-password`,
//         {
...
//       } else {
//         setForgotPasswordError(response.data.message || "Something went wrong");
//         setForgotPasswordMessage("");
//       }
//     } catch (error: any) {
//       setForgotPasswordError(
...
//                 <>
//                   <DialogHeader>
//                     <h3 className="text-lg font-medium text-center py-2 sm:py-4">
//                       Reset Your Password
//                     </h3>
//                   </DialogHeader>
...
//                     )}
//                   </div>
//                   <DialogFooter className="flex flex-col gap-2 py-2 sm:py-4">
//                     <Button
//                       type="button"
...
//                       className="w-full py-2 sm:py-3 rounded-md text-sm sm:text-base"
//                     >
//                       Back to Login
//                     </Button>
//                   </DialogFooter>
