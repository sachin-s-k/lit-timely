...
const AppointmentTypesList: React.FC = () => {
  ...
  const handleNavigation = (index: number) => {
    navigate("/events/user/me");
    dispatch(addActiveNavState(index as any));
  };

  return (
    <div className="px-4 sm:px-6 lg:px-8 py-6 w-full pb-20">
      ...
      <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-6 w-full md:w-1/2">
        Create New Event Type
      </h1>

      {/* Left-aligned vertical list - 50% width on medium screens and up */}
      ...
      {appointmentTypes.length === 0 && (
        <div className="text-center py-12 w-full md:w-1/2">
          <p className="text-gray-500">No appointment types available</p>
        </div>
      )}
    </div>
